...
web build:
 - http://mootools.net/core/c6db8b49e1a00dd70c1094f79964c66a

packager build:
 - packager build Core/Element.Dimensions Core/Request.HTML Core/Request.JSON Core/JSON Core/DOMReady
